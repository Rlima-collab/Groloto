 ...
 */
final class Version20251105150855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE WEEKEND (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, date_vendredi DATE NOT NULL, date_samedi DATE NOT NULL, date_dimanche DATE NOT NULL, date_creation DATETIME NOT NULL, date_lundi DATE DEFAULT NULL, date_mardi DATE DEFAULT NULL, date_mercredi DATE DEFAULT NULL, date_jeudi DATE DEFAULT NULL)');
