 ...
 */
final class Version20251021095616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__AFFECTATION_CRENEAU AS SELECT id, id_creneau, id_benevole, id_utilisateur, date_affectation, statut, remarque FROM AFFECTATION_CRENEAU');
        ...
        $this->addSql('INSERT INTO AFFECTATION_CRENEAU (id, id_creneau, id_benevole, id_utilisateur, date_affectation, statut, notes) SELECT id, id_creneau, id_benevole, id_utilisateur, date_affectation, statut, remarque FROM __temp__AFFECTATION_CRENEAU');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__CRENEAU AS SELECT id, id_evenement, titre, poste_requis, debut, fin, max_personnes, remarque, date_creation FROM CRENEAU');
        ...
        $this->addSql('INSERT INTO CRENEAU (id, id_evenement, titre, poste_requis, debut, fin, max_personnes, remarque, date_creation) SELECT id, id_evenement, titre, poste_requis, debut, fin, max_personnes, remarque, date_creation FROM __temp__CRENEAU');
