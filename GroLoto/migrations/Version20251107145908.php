 ...
 */
final class Version20251107145908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__NOTIFICATION AS SELECT id, id_destinataire, type, message, lien, lue, created_at, reponse FROM NOTIFICATION');
        $this->addSql('DROP TABLE NOTIFICATION');
        $this->addSql('CREATE TABLE NOTIFICATION (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_destinataire INTEGER NOT NULL, type VARCHAR(50) NOT NULL, message CLOB NOT NULL, lien VARCHAR(255) DEFAULT NULL, lue BOOLEAN DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, reponse CLOB DEFAULT NULL, FOREIGN KEY (id_destinataire) REFERENCES UTILISATEUR (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO NOTIFICATION (id, id_destinataire, type, message, lien, lue, created_at, reponse) SELECT id, id_destinataire, type, message, lien, lue, created_at, reponse FROM __temp__NOTIFICATION');
