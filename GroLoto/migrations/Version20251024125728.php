...
final class Version20251024125728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE EVENEMENT (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_weekend INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, lieu VARCHAR(255) DEFAULT NULL, date_creation DATETIME NOT NULL, FOREIGN KEY (id_weekend) REFERENCES WEEKEND (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__EVENEMENT AS SELECT id, id_weekend, nom, description, date_debut, date_fin, lieu, date_creation FROM EVENEMENT');
        $this->addSql('DROP TABLE EVENEMENT');
        $this->addSql('CREATE TABLE EVENEMENT (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, id_weekend INTEGER DEFAULT NULL, nom CLOB NOT NULL, description CLOB DEFAULT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, lieu CLOB DEFAULT NULL, date_creation DATETIME DEFAULT CURRENT_TIMESTAMP, CONSTRAINT FK_4FE476F1704F64DE FOREIGN KEY (id_weekend) REFERENCES WEEKEND (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO EVENEMENT (id, id_weekend, nom, description, date_debut, date_fin, lieu, date_creation) SELECT id, id_weekend, nom, description, date_debut, date_fin, lieu, date_creation FROM __temp__EVENEMENT');
        $this->addSql('DROP TABLE __temp__EVENEMENT');
        $this->addSql('CREATE INDEX IDX_4FE476F1704F64DE ON EVENEMENT (id_weekend)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__HELLOASSO AS SELECT id, id_evenement, id_externe, prenom, nom, email, telephone, type_ticket, date_achat, date_import FROM HELLOASSO');
