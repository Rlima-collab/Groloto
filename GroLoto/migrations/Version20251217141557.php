 ...
 */
final class Version20251217141557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE RECU_FISCAL (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, destinataire_id INTEGER NOT NULL, envoye_par_id INTEGER NOT NULL, type VARCHAR(20) NOT NULL, fichier VARCHAR(255) NOT NULL, annee INTEGER NOT NULL, created_at DATETIME NOT NULL, CONSTRAINT FK_AD0C71B0A4F84F6E FOREIGN KEY (destinataire_id) REFERENCES UTILISATEUR (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_AD0C71B0D603292 FOREIGN KEY (envoye_par_id) REFERENCES UTILISATEUR (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_AD0C71B0A4F84F6E ON RECU_FISCAL (destinataire_id)');
        $this->addSql('CREATE INDEX IDX_AD0C71B0D603292 ON RECU_FISCAL (envoye_par_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__BENEVOLE AS SELECT id, id_utilisateur, remarque, disponibilites, actif FROM BENEVOLE');
        $this->addSql('DROP TABLE BENEVOLE');
        $this->addSql('CREATE TABLE BENEVOLE (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_utilisateur INTEGER DEFAULT NULL, remarque CLOB DEFAULT NULL, disponibilites CLOB DEFAULT NULL, actif BOOLEAN DEFAULT 1 NOT NULL, FOREIGN KEY (id_utilisateur) REFERENCES UTILISATEUR (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO BENEVOLE (id, id_utilisateur, remarque, disponibilites, actif) SELECT id, id_utilisateur, remarque, disponibilites, actif FROM __temp__BENEVOLE');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__DEMANDE_ANNULATION AS SELECT id, id_affectation, id_benevole, id_admin_reponse, date_demande, statut, motif_benevole, tache_titre, message_admin, date_reponse FROM DEMANDE_ANNULATION');
        $this->addSql('DROP TABLE DEMANDE_ANNULATION');
        $this->addSql('CREATE TABLE DEMANDE_ANNULATION (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_affectation INTEGER DEFAULT NULL, id_benevole INTEGER NOT NULL, id_admin_reponse INTEGER DEFAULT NULL, date_demande DATETIME NOT NULL, statut VARCHAR(20) NOT NULL, motif_benevole CLOB DEFAULT NULL, tache_titre VARCHAR(255) DEFAULT NULL, message_admin CLOB DEFAULT NULL, date_reponse DATETIME DEFAULT NULL, CONSTRAINT FK_75084DE6ECCFAC24 FOREIGN KEY (id_affectation) REFERENCES AFFECTATION_TACHE (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE, FOREIGN KEY (id_benevole) REFERENCES BENEVOLE (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, FOREIGN KEY (id_admin_reponse) REFERENCES UTILISATEUR (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO DEMANDE_ANNULATION (id, id_affectation, id_benevole, id_admin_reponse, date_demande, statut, motif_benevole, tache_titre, message_admin, date_reponse) SELECT id, id_affectation, id_benevole, id_admin_reponse, date_demande, statut, motif_benevole, tache_titre, message_admin, date_reponse FROM __temp__DEMANDE_ANNULATION');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__INSCRIPTION_MECENE AS SELECT id, id_mecene, id_evenement, description_don, montant_estime, statut, date_inscription, remarques, remarque_acceptation, nom_don, categorie, quantite, valeur_unitaire, remarque_refus, adresse_postale, type_don FROM INSCRIPTION_MECENE');
        $this->addSql('DROP TABLE INSCRIPTION_MECENE');
        $this->addSql('CREATE TABLE INSCRIPTION_MECENE (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_mecene INTEGER NOT NULL, id_evenement INTEGER NOT NULL, description_don CLOB NOT NULL, montant_estime DOUBLE PRECISION DEFAULT NULL, statut VARCHAR(20) NOT NULL, date_inscription DATETIME NOT NULL, remarques CLOB DEFAULT NULL, remarque_acceptation CLOB DEFAULT NULL, nom_don VARCHAR(255) NOT NULL, categorie VARCHAR(50) NOT NULL, quantite INTEGER NOT NULL, valeur_unitaire DOUBLE PRECISION DEFAULT NULL, remarque_refus CLOB DEFAULT NULL, adresse_postale CLOB DEFAULT NULL, type_don VARCHAR(20) DEFAULT \'fonctionnement\' NOT NULL, FOREIGN KEY (id_mecene) REFERENCES MECENE (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, FOREIGN KEY (id_evenement) REFERENCES EVENEMENT (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO INSCRIPTION_MECENE (id, id_mecene, id_evenement, description_don, montant_estime, statut, date_inscription, remarques, remarque_acceptation, nom_don, categorie, quantite, valeur_unitaire, remarque_refus, adresse_postale, type_don) SELECT id, id_mecene, id_evenement, description_don, montant_estime, statut, date_inscription, remarques, remarque_acceptation, nom_don, categorie, quantite, valeur_unitaire, remarque_refus, adresse_postale, type_don FROM __temp__INSCRIPTION_MECENE');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__LOT AS SELECT id, id_weekend, id_mecene, titre, description, quantite, valeur_estimee, date_creation FROM LOT');
        $this->addSql('DROP TABLE LOT');
        $this->addSql('CREATE TABLE LOT (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_weekend INTEGER DEFAULT NULL, id_mecene INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, quantite INTEGER NOT NULL, valeur_estimee DOUBLE PRECISION NOT NULL, date_creation DATETIME DEFAULT NULL, FOREIGN KEY (id_mecene) REFERENCES MECENE (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, FOREIGN KEY (id_weekend) REFERENCES WEEKEND (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO LOT (id, id_weekend, id_mecene, titre, description, quantite, valeur_estimee, date_creation) SELECT id, id_weekend, id_mecene, titre, description, quantite, valeur_estimee, date_creation FROM __temp__LOT');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__MECENE AS SELECT id, id_utilisateur, organisation, siret, adresse_postale, logo, instagram, facebook FROM MECENE');
        $this->addSql('DROP TABLE MECENE');
        $this->addSql('CREATE TABLE MECENE (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_utilisateur INTEGER DEFAULT NULL, organisation VARCHAR(255) DEFAULT NULL, siret VARCHAR(50) DEFAULT NULL, adresse_postale CLOB DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, instagram VARCHAR(255) DEFAULT NULL, facebook VARCHAR(255) DEFAULT NULL, FOREIGN KEY (id_utilisateur) REFERENCES UTILISATEUR (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO MECENE (id, id_utilisateur, organisation, siret, adresse_postale, logo, instagram, facebook) SELECT id, id_utilisateur, organisation, siret, adresse_postale, logo, instagram, facebook FROM __temp__MECENE');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__PLAGE_HORAIRE AS SELECT id, id_tache, jour, heure_debut, heure_fin, max_personnes_plage FROM PLAGE_HORAIRE');
        $this->addSql('DROP TABLE PLAGE_HORAIRE');
        $this->addSql('CREATE TABLE PLAGE_HORAIRE (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_tache INTEGER NOT NULL, jour DATE NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, max_personnes_plage INTEGER DEFAULT NULL, FOREIGN KEY (id_tache) REFERENCES TACHE (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO PLAGE_HORAIRE (id, id_tache, jour, heure_debut, heure_fin, max_personnes_plage) SELECT id, id_tache, jour, heure_debut, heure_fin, max_personnes_plage FROM __temp__PLAGE_HORAIRE');
        $this->addSql('DROP TABLE __temp__PLAGE_HORAIRE');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__STOCK AS SELECT id, nom, categorie, quantite, unite, seuil, valeur_unitaire, remarque, derniere_modif, source, date_retour, preteur FROM STOCK');
        $this->addSql('DROP TABLE STOCK');
        $this->addSql('CREATE TABLE STOCK (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, categorie VARCHAR(50) DEFAULT NULL, quantite INTEGER DEFAULT 0 NOT NULL, unite VARCHAR(255) DEFAULT NULL, seuil INTEGER DEFAULT 0 NOT NULL, valeur_unitaire DOUBLE PRECISION DEFAULT \'0\' NOT NULL, remarque CLOB DEFAULT NULL, derniere_modif DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, source VARCHAR(20) DEFAULT \'achat\' NOT NULL, date_retour DATE DEFAULT NULL, preteur VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO STOCK (id, nom, categorie, quantite, unite, seuil, valeur_unitaire, remarque, derniere_modif, source, date_retour, preteur) SELECT id, nom, categorie, quantite, unite, seuil, valeur_unitaire, remarque, derniere_modif, source, date_retour, preteur FROM __temp__STOCK');
        $this->addSql('DROP TABLE __temp__STOCK');
        $this->addSql('CREATE TEMPORARY TABLE __temp__TACHE AS SELECT id, id_weekend, id_evenement, titre, poste_requis, debut, fin, max_personnes, remarque FROM TACHE');
        $this->addSql('DROP TABLE TACHE');
        $this->addSql('CREATE TABLE TACHE (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_weekend INTEGER NOT NULL, id_evenement INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL, poste_requis VARCHAR(255) DEFAULT NULL, debut DATETIME DEFAULT NULL, fin DATETIME DEFAULT NULL, max_personnes INTEGER DEFAULT NULL, remarque CLOB DEFAULT NULL, FOREIGN KEY (id_weekend) REFERENCES WEEKEND (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, FOREIGN KEY (id_evenement) REFERENCES EVENEMENT (id) ON UPDATE NO ACTION ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO TACHE (id, id_weekend, id_evenement, titre, poste_requis, debut, fin, max_personnes, remarque) SELECT id, id_weekend, id_evenement, titre, poste_requis, debut, fin, max_personnes, remarque FROM __temp__TACHE');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__UTILISATEUR AS SELECT id, id_role, email, mot_de_passe, prenom, nom, telephone, profile_image, date_creation, date_modification FROM UTILISATEUR');
        $this->addSql('DROP TABLE UTILISATEUR');
        $this->addSql('CREATE TABLE UTILISATEUR (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_role INTEGER NOT NULL, email VARCHAR(180) NOT NULL, mot_de_passe VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, profile_image VARCHAR(255) DEFAULT NULL, date_creation DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, date_modification DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, FOREIGN KEY (id_role) REFERENCES ROLE (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO UTILISATEUR (id, id_role, email, mot_de_passe, prenom, nom, telephone, profile_image, date_creation, date_modification) SELECT id, id_role, email, mot_de_passe, prenom, nom, telephone, profile_image, date_creation, date_modification FROM __temp__UTILISATEUR');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__WEEKEND AS SELECT id, nom, date_debut, date_fin, cover_image, description, date_creation FROM WEEKEND');
        $this->addSql('DROP TABLE WEEKEND');
        $this->addSql('CREATE TABLE WEEKEND (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, cover_image VARCHAR(255) DEFAULT NULL, description CLOB DEFAULT NULL, date_creation DATETIME NOT NULL)');
        $this->addSql('INSERT INTO WEEKEND (id, nom, date_debut, date_fin, cover_image, description, date_creation) SELECT id, nom, date_debut, date_fin, cover_image, description, date_creation FROM __temp__WEEKEND');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE RECU_FISCAL');
        $this->addSql('CREATE TEMPORARY TABLE __temp__AFFECTATION_TACHE AS SELECT id, id_tache, id_benevole, id_utilisateur, date_affectation, statut, remarque FROM AFFECTATION_TACHE');
        $this->addSql('DROP TABLE AFFECTATION_TACHE');
        ...
        $this->addSql('CREATE INDEX IDX_12694ECFE4DAA34E ON AFFECTATION_TACHE (id_benevole)');
        $this->addSql('CREATE INDEX IDX_12694ECF50EAE44 ON AFFECTATION_TACHE (id_utilisateur)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__BENEVOLE AS SELECT id, id_utilisateur, remarque, actif, disponibilites FROM BENEVOLE');
        $this->addSql('DROP TABLE BENEVOLE');
        $this->addSql('CREATE TABLE BENEVOLE (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, id_utilisateur INTEGER NOT NULL, remarque CLOB DEFAULT NULL, actif BOOLEAN DEFAULT 1, disponibilites CLOB DEFAULT NULL, CONSTRAINT FK_7232D39750EAE44 FOREIGN KEY (id_utilisateur) REFERENCES UTILISATEUR (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO BENEVOLE (id, id_utilisateur, remarque, actif, disponibilites) SELECT id, id_utilisateur, remarque, actif, disponibilites FROM __temp__BENEVOLE');
        $this->addSql('DROP TABLE __temp__BENEVOLE');
        ...
        $this->addSql('DROP TABLE __temp__CONTACT_MESSAGE');
        $this->addSql('CREATE INDEX IDX_B609370B26CA41A0 ON CONTACT_MESSAGE (repondu_par_id)');
        $this->addSql('CREATE INDEX idx_parent ON CONTACT_MESSAGE (parent_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__CONVENTION AS SELECT id, id_mecene, nom_modele, url_pdf, date_signature, methode_signature, date_creation FROM CONVENTION');
        $this->addSql('DROP TABLE CONVENTION');
        ...
        $this->addSql('CREATE INDEX IDX_76C8B6FB8B13D439 ON HISTORIQUE_STOCK (id_evenement)');
        $this->addSql('CREATE INDEX IDX_76C8B6FB50EAE44 ON HISTORIQUE_STOCK (id_utilisateur)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__INSCRIPTION_MECENE AS SELECT id, id_mecene, id_evenement, description_don, montant_estime, statut, date_inscription, remarques, nom_don, categorie, quantite, valeur_unitaire, remarque_refus, remarque_acceptation, adresse_postale, type_don FROM INSCRIPTION_MECENE');
        $this->addSql('DROP TABLE INSCRIPTION_MECENE');
        $this->addSql('CREATE TABLE INSCRIPTION_MECENE (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, id_mecene INTEGER NOT NULL, id_evenement INTEGER NOT NULL, description_don CLOB NOT NULL, montant_estime DOUBLE PRECISION DEFAULT NULL, statut CLOB DEFAULT \'en_attente\', date_inscription DATETIME DEFAULT CURRENT_TIMESTAMP, remarques CLOB DEFAULT NULL, nom_don CLOB NOT NULL, categorie CLOB NOT NULL, quantite INTEGER NOT NULL, valeur_unitaire DOUBLE PRECISION DEFAULT NULL, remarque_refus CLOB DEFAULT NULL, remarque_acceptation CLOB DEFAULT NULL, adresse_postale CLOB DEFAULT NULL, type_don CLOB DEFAULT \'fonctionnement\', CONSTRAINT FK_35E63F33D364722F FOREIGN KEY (id_mecene) REFERENCES MECENE (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_35E63F338B13D439 FOREIGN KEY (id_evenement) REFERENCES EVENEMENT (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO INSCRIPTION_MECENE (id, id_mecene, id_evenement, description_don, montant_estime, statut, date_inscription, remarques, nom_don, categorie, quantite, valeur_unitaire, remarque_refus, remarque_acceptation, adresse_postale, type_don) SELECT id, id_mecene, id_evenement, description_don, montant_estime, statut, date_inscription, remarques, nom_don, categorie, quantite, valeur_unitaire, remarque_refus, remarque_acceptation, adresse_postale, type_don FROM __temp__INSCRIPTION_MECENE');
        $this->addSql('DROP TABLE __temp__INSCRIPTION_MECENE');
        $this->addSql('CREATE INDEX IDX_35E63F33D364722F ON INSCRIPTION_MECENE (id_mecene)');
        $this->addSql('CREATE INDEX IDX_35E63F338B13D439 ON INSCRIPTION_MECENE (id_evenement)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__LOT AS SELECT id, id_mecene, id_weekend, titre, description, quantite, valeur_estimee, date_creation FROM LOT');
        $this->addSql('DROP TABLE LOT');
        $this->addSql('CREATE TABLE LOT (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, id_mecene INTEGER DEFAULT NULL, id_weekend INTEGER DEFAULT NULL, titre CLOB NOT NULL, description CLOB DEFAULT NULL, quantite INTEGER DEFAULT 1, valeur_estimee DOUBLE PRECISION DEFAULT \'0.0\', date_creation DATETIME DEFAULT CURRENT_TIMESTAMP, CONSTRAINT FK_9D266B91D364722F FOREIGN KEY (id_mecene) REFERENCES MECENE (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9D266B91704F64DE FOREIGN KEY (id_weekend) REFERENCES WEEKEND (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO LOT (id, id_mecene, id_weekend, titre, description, quantite, valeur_estimee, date_creation) SELECT id, id_mecene, id_weekend, titre, description, quantite, valeur_estimee, date_creation FROM __temp__LOT');
        $this->addSql('DROP TABLE __temp__LOT');
        $this->addSql('CREATE INDEX IDX_9D266B91D364722F ON LOT (id_mecene)');
        $this->addSql('CREATE INDEX IDX_9D266B91704F64DE ON LOT (id_weekend)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__MECENE AS SELECT id, id_utilisateur, organisation, siret, adresse_postale, logo, instagram, facebook FROM MECENE');
        $this->addSql('DROP TABLE MECENE');
        $this->addSql('CREATE TABLE MECENE (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, id_utilisateur INTEGER DEFAULT NULL, organisation CLOB NOT NULL, siret CLOB NOT NULL, adresse_postale CLOB DEFAULT NULL, logo CLOB DEFAULT NULL, instagram CLOB DEFAULT NULL, facebook CLOB DEFAULT NULL, CONSTRAINT FK_5AB004450EAE44 FOREIGN KEY (id_utilisateur) REFERENCES UTILISATEUR (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO MECENE (id, id_utilisateur, organisation, siret, adresse_postale, logo, instagram, facebook) SELECT id, id_utilisateur, organisation, siret, adresse_postale, logo, instagram, facebook FROM __temp__MECENE');
        $this->addSql('DROP TABLE __temp__MECENE');
        $this->addSql('CREATE INDEX IDX_5AB004450EAE44 ON MECENE (id_utilisateur)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__NOTIFICATION AS SELECT id, id_destinataire, type, message, lien, lue, created_at FROM NOTIFICATION');
        $this->addSql('DROP TABLE NOTIFICATION');
        $this->addSql('CREATE TABLE NOTIFICATION (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, id_destinataire INTEGER NOT NULL, type VARCHAR(50) NOT NULL, message CLOB NOT NULL, lien VARCHAR(255) DEFAULT NULL, lue BOOLEAN DEFAULT 0, created_at DATETIME NOT NULL, reponse CLOB DEFAULT NULL -- AJOUTÉ ICI
        , CONSTRAINT FK_2A663FDADD688AE0 FOREIGN KEY (id_destinataire) REFERENCES UTILISATEUR (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO NOTIFICATION (id, id_destinataire, type, message, lien, lue, created_at) SELECT id, id_destinataire, type, message, lien, lue, created_at FROM __temp__NOTIFICATION');
        $this->addSql('DROP TABLE __temp__NOTIFICATION');
        $this->addSql('CREATE INDEX IDX_2A663FDADD688AE0 ON NOTIFICATION (id_destinataire)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__PARAMETRE AS SELECT id, cle, valeur, date_modification FROM PARAMETRE');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__PLAGE_HORAIRE AS SELECT id, id_tache, jour, heure_debut, heure_fin, max_personnes_plage FROM PLAGE_HORAIRE');
        $this->addSql('DROP TABLE PLAGE_HORAIRE');
        $this->addSql('CREATE TABLE PLAGE_HORAIRE (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, id_tache INTEGER NOT NULL, jour DATE NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, max_personnes_plage INTEGER DEFAULT NULL, CONSTRAINT FK_59D5EA847D026145 FOREIGN KEY (id_tache) REFERENCES TACHE (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO PLAGE_HORAIRE (id, id_tache, jour, heure_debut, heure_fin, max_personnes_plage) SELECT id, id_tache, jour, heure_debut, heure_fin, max_personnes_plage FROM __temp__PLAGE_HORAIRE');
        $this->addSql('DROP TABLE __temp__PLAGE_HORAIRE');
        $this->addSql('CREATE INDEX IDX_59D5EA847D026145 ON PLAGE_HORAIRE (id_tache)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ROLE AS SELECT id, nom, description FROM ROLE');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__STOCK AS SELECT id, nom, categorie, quantite, unite, seuil, valeur_unitaire, remarque, derniere_modif, source, date_retour, preteur FROM STOCK');
        $this->addSql('DROP TABLE STOCK');
        $this->addSql('CREATE TABLE STOCK (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, nom CLOB NOT NULL, categorie CLOB DEFAULT NULL, quantite INTEGER DEFAULT 0, unite CLOB DEFAULT NULL, seuil INTEGER DEFAULT 0, valeur_unitaire DOUBLE PRECISION DEFAULT \'0.0\', remarque CLOB DEFAULT NULL, derniere_modif DATETIME DEFAULT CURRENT_TIMESTAMP, source CLOB DEFAULT \'achat\', date_retour DATE DEFAULT NULL, preteur CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO STOCK (id, nom, categorie, quantite, unite, seuil, valeur_unitaire, remarque, derniere_modif, source, date_retour, preteur) SELECT id, nom, categorie, quantite, unite, seuil, valeur_unitaire, remarque, derniere_modif, source, date_retour, preteur FROM __temp__STOCK');
        $this->addSql('DROP TABLE __temp__STOCK');
        $this->addSql('CREATE TEMPORARY TABLE __temp__TACHE AS SELECT id, id_weekend, id_evenement, titre, debut, fin, max_personnes, remarque, poste_requis FROM TACHE');
        $this->addSql('DROP TABLE TACHE');
        $this->addSql('CREATE TABLE TACHE (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, id_weekend INTEGER NOT NULL, id_evenement INTEGER DEFAULT NULL, titre CLOB NOT NULL, debut DATETIME NOT NULL, fin DATETIME NOT NULL, max_personnes INTEGER DEFAULT 1, remarque CLOB DEFAULT NULL, poste_requis CLOB DEFAULT NULL, CONSTRAINT FK_64D3E2C5704F64DE FOREIGN KEY (id_weekend) REFERENCES WEEKEND (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_64D3E2C58B13D439 FOREIGN KEY (id_evenement) REFERENCES EVENEMENT (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO TACHE (id, id_weekend, id_evenement, titre, debut, fin, max_personnes, remarque, poste_requis) SELECT id, id_weekend, id_evenement, titre, debut, fin, max_personnes, remarque, poste_requis FROM __temp__TACHE');
        $this->addSql('DROP TABLE __temp__TACHE');
        $this->addSql('CREATE INDEX IDX_64D3E2C5704F64DE ON TACHE (id_weekend)');
        $this->addSql('CREATE INDEX IDX_64D3E2C58B13D439 ON TACHE (id_evenement)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__UTILISATEUR AS SELECT id, id_role, email, mot_de_passe, prenom, nom, telephone, date_creation, date_modification, profile_image FROM UTILISATEUR');
        $this->addSql('DROP TABLE UTILISATEUR');
        $this->addSql('CREATE TABLE UTILISATEUR (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, id_role INTEGER NOT NULL, email CLOB NOT NULL, mot_de_passe CLOB DEFAULT NULL, prenom CLOB DEFAULT NULL, nom CLOB DEFAULT NULL, telephone CLOB DEFAULT NULL, date_creation DATETIME DEFAULT CURRENT_TIMESTAMP, date_modification DATETIME DEFAULT CURRENT_TIMESTAMP, profile_image CLOB DEFAULT NULL, CONSTRAINT FK_901FF15BDC499668 FOREIGN KEY (id_role) REFERENCES ROLE (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO UTILISATEUR (id, id_role, email, mot_de_passe, prenom, nom, telephone, date_creation, date_modification, profile_image) SELECT id, id_role, email, mot_de_passe, prenom, nom, telephone, date_creation, date_modification, profile_image FROM __temp__UTILISATEUR');
        $this->addSql('DROP TABLE __temp__UTILISATEUR');
        $this->addSql('CREATE INDEX IDX_901FF15BDC499668 ON UTILISATEUR (id_role)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__WEEKEND AS SELECT id, nom, date_debut, date_fin, date_creation, cover_image, description FROM WEEKEND');
        $this->addSql('DROP TABLE WEEKEND');
        $this->addSql('CREATE TABLE WEEKEND (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, nom CLOB NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, date_creation DATETIME DEFAULT CURRENT_TIMESTAMP, cover_image CLOB DEFAULT NULL, description CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO WEEKEND (id, nom, date_debut, date_fin, date_creation, cover_image, description) SELECT id, nom, date_debut, date_fin, date_creation, cover_image, description FROM __temp__WEEKEND');
        $this->addSql('DROP TABLE __temp__WEEKEND');
        $this->addSql('CREATE TEMPORARY TABLE __temp__messenger_messages AS SELECT id, body, headers, queue_name, created_at, available_at, delivered_at FROM messenger_messages');
        $this->addSql('DROP TABLE messenger_messages');
